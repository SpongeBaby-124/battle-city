...
export type { RawStageConfig, StageDifficulty } from './StageConfig'
export type { State } from '../reducers/index'
export type { BulletsMap } from '../reducers/bullets'
export type { TextsMap } from '../reducers/texts'
export type { TanksMap } from '../reducers/tanks'
export type { ScoresMap } from '../reducers/scores'
export type { ExplosionsMap } from '../reducers/explosions'
